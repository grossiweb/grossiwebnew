...
export default function DynamicPageContent({ content, isPost, slug }: DynamicPageContentProps) {
        ...
        <div className="relative z-10 container mx-auto px-6 pt-24 md:pt-28 pb-16 md:pb-24">
          <div className="max-w-3xl">
            ...
            {excerptHtml ? (
              ...
              <div className="mt-6 md:mt-8 text-lg md:text-2xl text-white/90 leading-relaxed">
          ...
          {isPost && (
            <div className="w-full mx-auto mb-12 text-center">
              <div className="flex flex-wrap justify-center items-center text-sm text-gray-500 space-x-4">
                ...
                {content.categories?.nodes?.length && content.categories.nodes.length > 0 && (
